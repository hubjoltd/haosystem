...
@Entity
@Table(name = "pr_stock_fulfillment_items")
public class PRStockFulfillmentItem {
    @Id
    ...
    @JoinColumn(name = "stock_fulfillment_id")
    @JsonIgnore
    private PRStockFulfillment stockFulfillment;
    ...
    public PRStockFulfillment getStockFulfillment() { return stockFulfillment; }
    public void setStockFulfillment(PRStockFulfillment stockFulfillment) { this.stockFulfillment = stockFulfillment; }
}
